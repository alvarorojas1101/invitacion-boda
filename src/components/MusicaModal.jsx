...
function MusicaModal() {
  ...
  const handleGuardarForm = handleSubmit(async (data) => {
    try {
      const datos = {
        ...data,
        fecha: new Date(), // Agregamos fecha de sugerencia
      };

      // Guardar en Firestore
      const docRef = await addDoc(
        collection(db, "recomendaciones_musica"),
        datos
      );
      ...
      setError("Ocurrió un error al enviar tu sugerencia");
    }
  });
